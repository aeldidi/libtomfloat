...
// The amalgamation script doesn't amalamate #includes which use angle brackets
// (<these ones>), so if you don't want to embed libtommath into this, and
// prefer to use the libtommath in your own build, comment out the #include
// using quotation marks and uncomment the one using angle brackets.
//
// NOTE: you should also remove the line in amalgamate.c which includes
// tommath.c in the c_files array if you wish to not embed libtommath.
// #include <tommath.h>
